...
class Persister
{
    ...
    private function formatData(Request $request)
    {
        return [
            'url' => $request->getUrl(),
            'started_at' => Carbon::createFromFormat('U.u', $request->getStartedAt())->format('Y-m-d H:i:s'),
            'stopped_at' => Carbon::createFromFormat('U.u', $request->getStoppedAt())->format('Y-m-d H:i:s'),
